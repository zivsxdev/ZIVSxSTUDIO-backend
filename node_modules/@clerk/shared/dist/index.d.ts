export { allSettled, createDeferredPromise, fastDeepMergeAndKeep, fastDeepMergeAndReplace, generateUuid, isDevelopmentEnvironment, isProductionEnvironment, isStaging, isTestEnvironment, logErrorInDevMode, noop } from './utils/index.js';
...
export { CLERK_NETLIFY_CACHE_BUST_PARAM, handleNetlifyCacheInDevInstance } from './netlifyCacheHandler.js';
import '@clerk/types';
